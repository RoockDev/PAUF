...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # creamos canciones y podcats
        # primero creamos 30 canciones
        ...
        # ahora vamos a crear 50 podcats
        ...
        # ahora creamos 500 reproducciones
        ...
        self.stdout.write(self.style.SUCCESS('Aiba la carga'))
